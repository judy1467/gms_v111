          ...
          //  }
            ...
            if (attack.skill == 35111001 || attack.skill == 35111009) {
                ...
                attack.skill = 35111001;
                 ...
                 player.getClient().getSession().write(MaplePacketCreator.BuffPacket.giveBuff(35111001, 2100000000, stat, ceffect));
                ...
                attack.skill = 35111009;
                 ...
                 player.getClient().getSession().write(MaplePacketCreator.BuffPacket.giveBuff(35111009, 2100000000, stat, ceffect));
                }else{                    
                attack.skill = 35111010;
                 ...
                 player.getClient().getSession().write(MaplePacketCreator.BuffPacket.giveBuff(35111010, 2100000000, stat, ceffect));
                        }
                }
                        ...
                        if(player.getSkillLevel(2120010) > 0 || player.getSkillLevel(2220010) > 0 || player.getSkillLevel(2320011) > 0) {
                            if(player.samemobid == 0) player.samemobid = monster.getId();
                                ...
                                if(player.samemobid == player.samemobid2 && player.samecount >= 1) {
                                    ...
                                    player.getClient().getSession().write(MaplePacketCreator.BuffPacket.giveBuff(2120010, 5000, stat, ceffect));
