...
public class MapleExtractor extends MapleMapObject {
    ...
    public void sendSpawnData(MapleClient client) {
        client.getSession().write(EtcPacket.makeExtractor(owner, ownerName, getTruePosition(), getTimeLeft(), itemId, fee));
    }

    @Override
    public void sendDestroyData(MapleClient client) {
        client.getSession().write(EtcPacket.removeExtractor(this.owner));
    }
