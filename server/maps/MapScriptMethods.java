...
public class MapScriptMethods {
    ...
    public static void startScript_FirstUser(MapleClient c, String scriptName) {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case killing_BonusSetting: { //spawns monsters according to mapid
                ...
                c.getPlayer().getMap().resetFully();
                c.getSession().write(EtcPacket.showEffect("killing/bonus/bonus"));
                c.getSession().write(EtcPacket.showEffect("killing/bonus/stage"));
    ...
    public static void startScript_User(final MapleClient c, String scriptName) {
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            case q31103s:
                ...
                break;
            case Resi_tutor20:
                c.getSession().write(EtcPacket.MapEff("resistance/tutorialGuide"));
                break;
            case Resi_tutor30:
            ...
            case mPark_stageEff:
                ...
                if (stage == 5) {
                    c.getSession().write(EtcPacket.MapEff("monsterPark/stageEff/final"));
                } else {
                    c.getSession().write(EtcPacket.MapEff("monsterPark/stageEff/stage"));
		    c.getSession().write(EtcPacket.MapEff("monsterPark/stageEff/number/" + (stage + 1)));
                }
		...
		break;  
            case TD_MC_title: {
                ...
                c.getSession().write(UIPacket.IntroLock(false));
                c.getSession().write(MaplePacketCreator.enableActions());
                c.getSession().write(EtcPacket.MapEff("temaD/enter/mushCatle"));
                break;
            }
            case TD_NC_title: {
                switch ((c.getPlayer().getMapId() / 100) % 10) {
                    case 0:
                        c.getSession().write(EtcPacket.MapEff("temaD/enter/teraForest"));
                        break;
                    case 1:
                    case 2:
                    case 3:
                    ...
                    case 5:
                    case 6:
                        c.getSession().write(EtcPacket.MapEff("temaD/enter/neoCity" + ((c.getPlayer().getMapId() / 100) % 10)));
                        break;
                }
                break;
            }
            ...
            case ds_tuto_home_before: {
                ...
                c.getSession().write(EtcPacket.showEffect("demonSlayer/text11"));
            ...
            case ds_tuto_3_0: {
                ...
                c.getSession().write(UIPacket.getDirectionInfo(1, 30));
                c.getSession().write(UIPacket.getDirectionStatus(true));
                c.getSession().write(EtcPacket.showEffect("demonSlayer/text12"));
            ...
            case ds_tuto_2_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.getSession().write(UIPacket.getDirectionInfo(3, 0));
                        c.getSession().write(EtcPacket.showEffect("demonSlayer/text13"));
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.getSession().write(EtcPacket.showEffect("demonSlayer/text14"));
                        c.getSession().write(UIPacket.getDirectionInfo(1, 4000));
                    }
                }, 1500);
                EventTimer.getInstance().schedule(new Runnable() {
            ...
            case ds_tuto_1_before: {
                ...
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.getSession().write(UIPacket.getDirectionInfo(3, 0));
                        c.getSession().write(EtcPacket.showEffect("demonSlayer/text8"));
                        c.getSession().write(UIPacket.getDirectionInfo(1, 500));
                    }
                }, 1000);
                EventTimer.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        c.getSession().write(EtcPacket.showEffect("demonSlayer/text9"));
            ...
            case ds_tuto_0_0: {
                ...
                c.getPlayer().changeSkillsLevel(sa);
                c.getSession().write(UIPacket.getDirectionInfo(3, 0));
                c.getSession().write(EtcPacket.showEffect("demonSlayer/back"));
                c.getSession().write(EtcPacket.showEffect("demonSlayer/text0"));
                c.getSession().write(UIPacket.getDirectionInfo(1, 500));
                c.getPlayer().setDirection(0);
            ...
            case Massacre_result: { //clear, give exp, etc.
                //if (c.getPlayer().getPyramidSubway() == null) {
                c.getSession().write(EtcPacket.showEffect("killing/fail"));
                //} else {
    ...
    private static void sendDojoClock(MapleClient c, int time) {
        c.getSession().write(EtcPacket.getClock(time));
    }

    private static void sendDojoStart(MapleClient c, int stage) {
        c.getSession().write(EtcPacket.environmentChange("Dojang/start", 4));
        c.getSession().write(EtcPacket.environmentChange("dojang/start/stage", 3));
        c.getSession().write(EtcPacket.environmentChange("dojang/start/number/" + stage, 3));
        c.getSession().write(EtcPacket.trembleEffect(0, 1));
    }
                ...
                for (String s : di.eventQ) {
                    switch (directionInfo.fromString(s)) {
                        ...
                        case merTutorDrecotion21:
                            ...
                            break;
                        case ds_tuto_0_2:
                            c.getSession().write(EtcPacket.showEffect("demonSlayer/text1"));
                            break;
                        case ds_tuto_0_1:
                            c.getSession().write(UIPacket.getDirectionInfo(3, 2));
                            break;
                        case ds_tuto_0_3:
                            c.getSession().write(EtcPacket.showEffect("demonSlayer/text2"));
                            EventTimer.getInstance().schedule(new Runnable() {

                                public void run() {
                                    c.getSession().write(UIPacket.getDirectionInfo(1, 4000));
                                    c.getSession().write(EtcPacket.showEffect("demonSlayer/text3"));
                                }
                            }, 2000);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.getSession().write(UIPacket.getDirectionInfo(1, 500));
                                    c.getSession().write(EtcPacket.showEffect("demonSlayer/text4"));
                                }
                            }, 6000);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.getSession().write(UIPacket.getDirectionInfo(1, 4000));
                                    c.getSession().write(EtcPacket.showEffect("demonSlayer/text5"));
                                }
                            }, 6500);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.getSession().write(UIPacket.getDirectionInfo(1, 500));
                                    c.getSession().write(EtcPacket.showEffect("demonSlayer/text6"));
                                }
                            }, 10500);
                            EventTimer.getInstance().schedule(new Runnable() {
                                ...
                                public void run() {
                                    c.getSession().write(UIPacket.getDirectionInfo(1, 4000));
                                    c.getSession().write(EtcPacket.showEffect("demonSlayer/text7"));
                                }
                            }, 11000);
                            EventTimer.getInstance().schedule(new Runnable() {
